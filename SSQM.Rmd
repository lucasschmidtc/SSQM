...
This section is dedicated to our third goal, of evaluating techniques of search-space reduction, namely the use of Random Sampling as proposed by @Renard:2015wv; the exploration of the shapelets that have a specific length, as proposed by @Hills:2013dk; and the evaluation of how these techniques affects the accuracy in comparison to when the full set of shapelets is used.
